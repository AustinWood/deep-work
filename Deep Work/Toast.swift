...
let HRToastPositionDefault  =   "center" // "bottom"
...
extension UIView {
    ...
    func makeToastActivity(position pos: AnyObject, message msg: String = "") {
        ...
        activityView.backgroundColor = CustomColor.pinkHot.withAlphaComponent(HRToastOpacity)
    ...
    func viewForMessage(_ msg: String?, title: String?, image: UIImage?) -> UIView? {
        ...
        wrapperView.backgroundColor = CustomColor.pinkHot.withAlphaComponent(HRToastOpacity)
